Config = {
    ...
    Locations = {
        ...
        [21] = {
            ["shelfs"] = {
                {["x"] = 229.97, ["y"] = -898.21, ["z"] = 30.69, ["value"] = "checkout"},
                {["x"] = 228.16, ["y"] = -900.88, ["z"] = 30.69, ["value"] = "drinks"},
				{["x"] = 231.96, ["y"] = -895.62, ["z"] = 30.69, ["value"] = "diverse"},
            },
            ["blip"] = {
                ["x"] = 227.91, ["y"] = -900.64, ["z"] = 30.69
            },
            ["cashier"] = {
                ["x"] = 231.7, ["y"] = -898.48, ["z"] = 29.69, ["h"] = 52.25
            },
        },
        [22] = {
            ["shelfs"] = {
                {["x"] = 151.42, ["y"] = -969.28, ["z"] = 30.09, ["value"] = "checkout"},
                {["x"] = 152.76, ["y"] = -967.32, ["z"] = 30.09, ["value"] = "Fructe"},
            },
            ["blip"] = {
                ["x"] = 152.76, ["y"] = -967.32, ["z"] = 30.09
            },
            ["cashier"] = {
                ["x"] = 149.63, ["y"] = -969.37, ["z"] = 29.09, ["h"] = 272.45
            },
        },
		[23] = {
            ["shelfs"] = {
                {["x"] = 153.13, ["y"] = -979.38, ["z"] = 30.09, ["value"] = "checkout"},
                {["x"] = 153.38, ["y"] = -977.22, ["z"] = 30.09, ["value"] = "Fructe"},
            },
            ["blip"] = {
                ["x"] = 153.38, ["y"] = -977.22, ["z"] = 30.09
            },
            ["cashier"] = {
                ["x"] = 151.23, ["y"] = -979.71, ["z"] = 29.09, ["h"] = 285.94
            },
        },
        [24] = {
            ["shelfs"] = {
                {["x"] = 255.61, ["y"] = -704.71, ["z"] = 44.69, ["value"] = "checkout"},
                {["x"] = 258.25, ["y"] = -705.59, ["z"] = 44.69, ["value"] = "drinks"},
				{["x"] = 260.4, ["y"] = -706.44, ["z"] = 44.69, ["value"] = "diverse"},
            },
            ["blip"] = {
                ["x"] = 260.4, ["y"] = -706.44, ["z"] = 44.69
            },
            ["cashier"] = {
                ["x"] = 257.42, ["y"] = -703.06, ["z"] = 43.88, ["h"] = 163.31
            },
        },
        [25] = {
            ["shelfs"] = {
                {["x"] = 247.36, ["y"] = -880.55, ["z"] = 30.5, ["value"] = "checkout"},
                {["x"] = 247.96, ["y"] = -879.29, ["z"] = 30.5, ["value"] = "drinks"},
				{["x"] = 246.97, ["y"] = -881.7, ["z"] = 30.5, ["value"] = "readymeal"},
            },
            ["blip"] = {
                ["x"] = 248.68, ["y"] = -880.62, ["z"] = 30.5
            },
            ["cashier"] = {
                ["x"] = 248.68, ["y"] = -880.62, ["z"] = 29.50, ["h"] = 70.71
            },
        },
    },
    ...
    Items = {
        ["drinks"] = {
            ...
            {label = "Fanta", item = "fanta", price = 14},
            {label = "Sprite", item = "sprite", price = 14},
            {label = "Loka", item = "loka", price = 10},
        },
        ["snacks"] = {
            {label = "Pufuleti", item = "cheesebows", price = 12},
            {label = "Chipsuri", item = "chips", price = 12},
            {label = "Ciocolata", item = "marabou", price = 12},
        },
        ["readymeal"] = {
			{label = "Shaorma", item = "bread", price = 30},
            {label = "Pizza", item = "pizza", price = 30},
            {label = "Hamburgher", item = "burger", price = 27},
            {label = "Carbonara", item = "pastacarbonara", price = 18},
            {label = "Tocanita", item = "macka", price = 8},
        },
        ["diverse"] = {
            {label = "Vin", item = "vittvin", price = 10},
            {label = "Bere", item = "beer", price = 20},
            {label = "vodka", item = "vodka", price = 20},
			{label = "tequila", item = "tequila", price = 20},
			
        },
		["Fructe"] = {
            {label = "Mere", item = "mere", price = 23},
            {label = "Pere", item = "pere", price = 34},
            {label = "Banane", item = "banane", price = 23},
			{label = "Struguri", item = "struguri", price = 23},
